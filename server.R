      ...
      if (input$selected1 == 'vorp_diff') {
        if (input$selected2 == 'Top 10') {
          team_VORP %>%
            ...
            top_n(10, vorp_diff) %>% rename(
              "Team" = team,
              "Total Picks" = total_picks,
              "Value Over Replacement" = VORP,
              "Avergae Value Over Replacement" = avg_VORP,
              "Expected Value Over Replacement" = expected_vorp,
